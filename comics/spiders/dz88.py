...
class Dz88Spider(scrapy.Spider):
    '''
    classdocs
    '''
    name = 'dz88';
    allowed_domains = ['www.dz88.com'];
    ...
    def parse(self, response):
        ...
        dd = sel.xpath('//li/a[@style="font-size:14px"]');
        id = 0;        
        for d in dd:
            id += 1;
    ...
    def parse_page(self, response):
        ...
        sel = Selector(response);
        content = sel.xpath('//div[@id="view_content_txt"]/text()').extract();
