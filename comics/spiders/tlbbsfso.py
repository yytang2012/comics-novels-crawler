...
class TlbbsfsoSpider(scrapy.Spider):
    '''
    classdocs
    '''
    name = 'tlbbsfso';
    allowed_domains = ['www.tlbbsfso.com'];
    ...
    def parse_page(self, response):
        ...
        sel = Selector(response);
        content = sel.xpath('//div[@class="content"]/text()').extract();
        content = polishContent(content, 0);
